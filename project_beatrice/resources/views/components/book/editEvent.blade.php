<form class="form-horizontal" id="edit-event-form" name="edit-event-form" action="{{ route('event.edit') }}"
    ...
    <div id="event-guests-div" class="form-group col-sm-10">
        <div class="input-group">
            ...
            <input type="number" min="0" max="999" id="event-guests" step="1" name="seats"
                class="form-control" placeholder="{{ trans('labels.availableSeats') }}"
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4" style="padding-top: 1%">
                    <label for="mySubmit_event" class="btn btn-primary btn-large btn-block">@include('icons.confirm')
