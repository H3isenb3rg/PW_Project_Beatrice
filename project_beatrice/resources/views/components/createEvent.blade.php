<div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body">
            <form id="event-form" name="event-form" action="{{ route('event.create') }}" method="post"
                onload="set_current_date">
                @csrf
                <div class="row">
                    <div class="col-sm-8">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div id="event-description-div" class="form-group">
                                    <textarea required id="event-description" name="description" rows="4" class="form-control"
                            ...
                            <div class="col-sm-12">
                                <div id="event-date-div" class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input required id="event-date" type="date" name="date"
                                            class="form-control">
                                    </div>
                                    <span class="help-block"></span>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div id="event-guests-div" class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" min="0" max="999" id="event-guests"
                                            step="1" name="seats" class="form-control"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3" style="padding-top: 1%">
                        <a href="{{ route('home') }}" class="btn btn-danger btn-block">@include('icons.close')
                            {{ trans('Cancel') }}</a>
                    </div>
                </div>
            </form>
